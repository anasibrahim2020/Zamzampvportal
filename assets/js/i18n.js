...
const I18N_EN = {
  ...
  'يوصلك إشعار فوري على جهازك عند كل حدث يخصّك — حتى والبوابة مقفولة.':'Get an instant notification on your device for anything that concerns you, even with the portal closed.',
  ...
  'تقدر توقفها في أي وقت من إعدادات المتصفح.':'You can turn them off any time in your browser settings.',
  'تفعيل الإشعارات':'Enable notifications',
  'مش دلوقتي':'Not now',
  'تم تفعيل الإشعارات':'Notifications enabled',
  'هيوصلك إشعار على الجهاز ده عند كل حدث يخصّك.':'This device will now receive notifications that concern you.',
  'عشان توصلك إشعارات الطلبات على الآيفون، لازم تضيف البوابة للشاشة الرئيسية الأول.':'To receive notifications on iPhone, add the portal to your Home Screen first.',
  'الخطوة ١':'Step 1',
  'الخطوة ٢':'Step 2',
  'الخطوة ٣':'Step 3',
  'اضغط زر المشاركة في سفاري':'Tap the Share button in Safari',
  ...
  'بعدها هيظهرلك طلب تفعيل الإشعارات.':'The enable prompt will appear after that.',
  'المحاسب':'Accountant',
  'الموظف':'Employee',
