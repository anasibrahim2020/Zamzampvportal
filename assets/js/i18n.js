...
const I18N_EN = {
  ...
  'تعذّر الاتصال بالخادم — حاول مرة أخرى':'Connection error — please try again',
  ...
  'التحويل المجمّع يربط أكثر من طلب بإثبات تحويل واحد. حدّد طلبين أو أكثر.':'A grouped transfer links more than one request to a single transfer proof. Please select two or more requests.',
  ...
  'حدث خطأ أثناء رفع الإثبات أو ربط الطلبات. تحقّق من الاتصال وحاول مرة أخرى.':'An error occurred while uploading the proof or linking the requests. Check your connection and try again.',
  ...
  'حدث خطأ أثناء حذف المجموعة. حاول مرة أخرى.':'An error occurred while deleting the group. Please try again.',
  ...
  'تعذّر حفظ الاعتماد — تأكّد من تفعيل سياسة التعديل (update) في Supabase (راجع كود SQL في التعليمات).':'Could not save the approval — make sure the update policy is enabled in Supabase (see the SQL in the setup guide).',
  ...
  'تعذّر الحفظ — تأكّد من تسجيل دخولك ومن أن جدول requests مهيّأ في Supabase.':'Could not save — make sure you are signed in and that the requests table is set up in Supabase.',
  ...
  'حدث خطأ أثناء تنزيل إثبات التحويل.':'An error occurred while downloading the transfer proof.',
  ...
  'منع المتصفح فتح نافذة الطباعة. اسمح بالنوافذ المنبثقة ثم حاول مرة أخرى.':'The browser blocked the print window. Please allow pop-ups and try again.',
  ...
  'حدث خطأ أثناء تجهيز نسخة الطلب PDF. حاول مرة أخرى.':'An error occurred while preparing the request PDF. Please try again.',
  ...
  /* ── رسائل Supabase ── */
  '<div class="arc-note">الأرشيف السحابي غير مفعّل بعد. الطلبات تعمل وتُطبع وتُحمّل بشكل طبيعي.<br>لحفظ الطلبات وعرضها هنا للجميع، أضف رابط ومفتاح Supabase في أعلى كود الملف.</div>':'<div class="arc-note">The cloud archive is not enabled yet. Requests still work, print and download normally.<br>To save requests and show them here for everyone, add your Supabase URL and key at the top of the script file.</div>',
  ...
  'لا توجد طلبات بانتظار اعتمادك':'Nothing awaiting your approval',
  ...
  'لا توجد طلبات جاهزة للتحويل':'No requests ready to transfer',
  'ستظهر هنا بعد الاعتماد':'They appear here once approved',
  'اعتماد':'Approve',
  ...
  'لا توجد طلبات قيد التنفيذ':'No requests in progress',
